                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                                        ...
                                        <div className="flex flex-col gap-y-2">
                                            <div className="flex items-center gap-x-5">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <input onChange={handleImageChange} className="hidden" accept=".jpg, .png, .jpeg, .svg" type="file" ref={inputRef} disabled={isPending} />
                                                    {field.value ? (
                                                        ...
                                                        <Button type="button" disabled={isPending} variant="teritary" size="xs" className="w-fit mt-2" onClick={() => inputRef.current?.click()}>Upload Image</Button>
                                                    )}                                            </div>
                                            </div>
                                        </div>
                                    )}
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Button disabled={isPending} type="submit" size="lg" variant="primary">Save  Changes</Button>
                            </div>
                        </form>
                    </Form>
                </CardContent>
                ...
                <CardContent className="p-7">
                    <div className="flex flex-col">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Use the invite link  to add members to your wokspace.
                        </p>
                        <div className="mt-4">
